...
export const filterAttributesSchema = z.object({
  ...
  certifications: z.array(z.enum(CERTIFICATION_OPTIONS).or(z.string())).optional(),
  uses: z.array(z.enum(USES_OPTIONS).or(z.string())).optional(),
  protection_tags: z.array(z.enum(PROTECTION_TAGS_OPTIONS).or(z.string())).optional(),
