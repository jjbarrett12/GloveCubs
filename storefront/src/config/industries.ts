...
export const INDUSTRIES: Record<IndustryKey, IndustryConfig> = {
  janitorial: {
    ...
    featuredCollections: [
      { title: "Nitrile Exam Gloves (High-Volume)", description: "Powder-free, textured grip for high-turnover cleaning.", storeHref: getStoreHrefForIntent("store.cat.nitrile-gloves"), badge: "High volume" },
    ...
    useCases: [
      ...
      { title: "Repeat quote requests", description: "Rebuild quote lines from saved Quicklists—formal pricing confirmed on review." },
    ...
    faq: [
      ...
      { q: "Can I reorder the same items quickly?", a: "Yes. Use Quicklists to save your standard lines and build a repeat quote request—formal pricing and availability are confirmed when our team reviews your request." },
  ...
  healthcare: {
    ...
    featuredCollections: [
      { title: "Nitrile Exam Gloves (High-Volume)", description: "Powder-free, textured grip for exams and procedures.", storeHref: getStoreHrefForIntent("store.cat.nitrile-gloves"), badge: "High volume" },
    ...
    faq: [
      ...
      { q: "Do you support reorder and Quicklists?", a: "Yes. Save your standard gloves as a Quicklist and add selected lines to a quote request. Formal pricing is confirmed on review—not self-serve checkout." },
    ],
  ...
  industrial: {
    ...
    faq: [
      ...
      { q: "How do reorders work?", a: "Save your standard gloves in a Quicklist and build a repeat quote request. Our team confirms case pricing and lead times before anything ships." },
    ],
