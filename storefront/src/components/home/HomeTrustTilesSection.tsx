      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-3.5 sm:grid-cols-3 sm:gap-4 lg:grid-cols-6 lg:gap-5">
          {TILES.map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="rounded-xl border border-neutral-400/25 bg-neutral-100 p-6 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.85)] transition hover:-translate-y-0.5 hover:border-[#f06232]/40 hover:shadow-md"
            >
              <Icon className="mx-auto mb-3 h-10 w-10 text-[#f06232]" strokeWidth={2} aria-hidden />
