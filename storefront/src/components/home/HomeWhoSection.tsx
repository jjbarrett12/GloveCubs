      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            ...
            className="block rounded-2xl border border-neutral-300/90 bg-white p-7 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition hover:-translate-y-0.5 hover:border-[#FF5500]/60 hover:shadow-md"
          >
            <IndustryIcon>
            ...
            <span className="mt-3.5 inline-block text-sm font-semibold text-[#FF5500]">View industry page →</span>
          </Link>
          <Link
