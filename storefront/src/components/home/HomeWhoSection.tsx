      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          <h2 id="who-heading" className="mb-3 text-3xl font-extrabold tracking-tight text-neutral-900 md:text-4xl">
            Built for the People Doing the Buying
          </h2>
          <p className="mx-auto max-w-xl text-base leading-relaxed text-neutral-600 md:text-[17px]">
            Operators, procurement, and facilities teams—not random shoppers.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            href="/industries/janitorial"
            className="block rounded-2xl border border-neutral-300/90 bg-white p-7 shadow-[0_2px_8px_rgba(0,0,0,0.06)] transition hover:-translate-y-0.5 hover:border-[#FF7A00]/60 hover:shadow-md"
          >
            <IndustryIcon>
            ...
            <span className="mt-3.5 inline-block text-sm font-semibold text-[#FF7A00]">View industry page →</span>
          </Link>
          <Link
