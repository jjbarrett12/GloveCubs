...
export function HomeHeroExpress() {
  return (
    <section
      ...
      aria-label="Hero"
    >
      <div className="pointer-events-none absolute -right-24 -top-24 h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(255,85,0,0.09)_0%,transparent_72%)]" />
      ...
      <div className="relative z-[1] mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-[1400px] grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <div className="mb-6 flex flex-wrap gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-br from-[#FF5500] to-[#FF5500] px-8 py-4 text-base font-bold text-white shadow-[0_8px_24px_rgba(255,85,0,0.35)] transition hover:-translate-y-0.5 hover:shadow-[0_10px_28px_rgba(255,85,0,0.42)]"
              >
              ...
              <Link
                href="/glove-finder"
                className="inline-flex items-center gap-2 rounded-xl border-2 border-[#FF5500]/75 bg-white/[0.04] px-6 py-3.5 text-sm font-semibold text-[#FF5500] backdrop-blur-[2px] transition hover:-translate-y-0.5 hover:border-[#FF5500] hover:bg-white/[0.07] hover:text-[#FF5500] hover:shadow-md"
              >
            ...
            <div className="mb-8 flex flex-wrap gap-8 text-[15px]">
              <Link href="/request-pricing" className="flex items-center gap-2 font-semibold text-[#FF5500] hover:translate-x-1">
                <Bolt className="h-3.5 w-3.5" />
                Request an RFQ in 60 seconds →
              </Link>
              <Link href="/contact" className="flex items-center gap-2 font-medium text-white/70 hover:text-[#FF5500]">
                <Headphones className="h-3.5 w-3.5" />
                Talk to a glove specialist →
              </Link>
              <Link href="/#bulk-order" className="flex items-center gap-2 font-medium text-white/70 hover:text-[#FF5500]">
                <Boxes className="h-3.5 w-3.5" />
                Start bulk order →
              </Link>
            </div>
            <div className="max-w-[500px] rounded-2xl border-2 border-[#FF5500]/35 bg-white p-6 shadow-md">
              <div className="grid grid-cols-3 gap-5 text-center text-sm">
                <div className="rounded-lg p-3.5 transition hover:bg-[#FF5500]/10">
                  <FileText className="mx-auto mb-2 h-6 w-6 text-[#FF5500]" />
                  <div className="font-semibold text-neutral-900">Net Terms</div>
                  <div className="text-neutral-600">Approved accounts</div>
                </div>
                <div className="rounded-lg p-3.5 transition hover:bg-[#FF5500]/10">
                  <Boxes className="mx-auto mb-2 h-6 w-6 text-[#FF5500]" />
                  <div className="font-semibold text-neutral-900">Case &amp; Pallet</div>
                  <div className="text-neutral-600">Bulk ordering</div>
                </div>
                <div className="rounded-lg p-3.5 transition hover:bg-[#FF5500]/10">
                  <UserRound className="mx-auto mb-2 h-6 w-6 text-[#FF5500]" />
          ...
          <div className="flex flex-col gap-4">
            <QuickBulkBuilder />
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#FF5500] to-[#FF5500] p-6 text-white shadow-md">
              ...
              <Link
                ...
                className="block w-full rounded-xl bg-white py-3 text-center text-sm font-semibold text-[#FF5500]"
              >
