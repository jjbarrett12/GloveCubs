    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 md:hidden">
      <div className="pointer-events-auto mx-auto flex max-w-[1440px] gap-2 border-t border-white/10 bg-[#0a0a0a]/95 px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur-sm">
        ...
        <Link
          ...
          className="inline-flex h-10 shrink-0 items-center justify-center rounded-md border border-[#f06232]/50 px-3 text-xs font-semibold text-white hover:bg-[#f06232]/10"
        >
          Request pricing
        </Link>
      </div>
