      ...
      <div className="space-y-6 text-white/80">
        <section className="rounded-xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <p className="mt-2 text-sm">
            <a href={SITE_PHONE_TEL_HREF} className="font-medium text-[#FF7A00] hover:underline">
              {SITE_PHONE_DISPLAY}
            </a>{" "}
        ...
        <section className="rounded-xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <p className="mt-2 text-sm">
            <a href={SITE_SALES_MAILTO_HREF} className="font-medium text-[#FF7A00] hover:underline">
              {SITE_SALES_EMAIL}
            </a>
          </p>
        </section>
        <section className="rounded-xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <Link
            ...
            className="mt-4 inline-flex rounded-lg bg-[#FF7A00] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#e56e00]"
          >
            Request pricing
          </Link>
        </section>
        <section className="rounded-xl border border-white/10 bg-white/[0.04] p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link
              href="/glove-finder"
              className="inline-flex rounded-lg border border-white/20 px-4 py-2 text-sm font-semibold text-white/90 hover:border-[#FF7A00]/50"
            >
              AI Glove Finder
            </Link>
            <Link
