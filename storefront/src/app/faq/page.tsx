    ...
    >
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        <Link
          ...
          className="inline-flex rounded-lg bg-[#FF7A00] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#e56e00]"
        >
          Request pricing
        </Link>
        <Link
          href="/contact"
          className="inline-flex rounded-lg border border-white/20 px-5 py-2.5 text-sm font-semibold text-white/90 hover:border-[#FF7A00]/50"
        >
          Contact
        </Link>
      </div>
