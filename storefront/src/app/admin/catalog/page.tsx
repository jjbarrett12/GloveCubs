    ...
    <div>
      ...
      {!configured ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {buckets.map((b) => (
            <div key={b.key} data-bucket={b.key} className={`${adminCardSurface} p-4 transition-colors hover:bg-admin-surface-muted`}>
      ...
      <p className="mt-6 text-xs text-admin-muted">
        Counts are sampled for speed. For a full reconciliation export, use your reporting database or ask your data team—this
        screen is meant for day-to-day health checks.{" "}
