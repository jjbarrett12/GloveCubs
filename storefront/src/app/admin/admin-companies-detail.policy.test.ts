...
describe("admin company detail page (Phase C)", () => {
  it("includes profile, pricing, members, quotes, orders, deferred quicklist, payment placeholder", () => {
    ...
    expect(s).toContain("dedicated quicklist data model approved in Phase D");
