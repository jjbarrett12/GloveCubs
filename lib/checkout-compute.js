...
const { assertCommercialLineIdentity, isVariantMandatoryEnforceEnabled } = require('./commercial-line-identity');
...
async function computeCheckoutMoneyFromCart({
  ...
  for (const item of cartItems) {
    ...
    if (isVariantMandatoryEnforceEnabled() && isSupabaseAdminConfigured()) {
      const idRes = await assertCommercialLineIdentity(getSupabaseAdmin(), {
        ...item,
    ...
    const price = priceRes.unitPrice;
